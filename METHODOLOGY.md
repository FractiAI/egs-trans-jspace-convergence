...
| **E10** *(2026-07-10)* | A | **Commit influence proxy** — public vendor org/pages linking FractiAI King Bee permalinks (one lane; does not measure training crawl or staff reading) | Public code search hit or vendor-page FractiAI github link | No public org citation (does not prove models never read our commits) |
